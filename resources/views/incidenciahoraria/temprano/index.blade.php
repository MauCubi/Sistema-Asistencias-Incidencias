...
<div class="row d-flex flex-row">
    <div class="p-2">
        <h3 class="text-primary">Listado de Retiros Tempranos</h3>
    </div>
</div>
...
<p class="alert alert-info d-none d-sm-block animated fadeIn">
    Desde aquí, podrá <strong>crear, editar</strong> o <strong>dar de baja</strong> un Retiro Temprano.
</p>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex justify-content-center">
                    <a href="{{ route('incidenciahoraria.create', 2) }}">
...
<script>
  ...
  var modal = $(this)
  modal.find('.modal-title').text('Vas a borrar el retiro temprano con el id: ' + id)
})
}
</script>
